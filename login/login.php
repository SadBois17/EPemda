...
<body>
 ...
 <div class="col-lg-10 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                   <a href="pengunjung.php"> <h1 class="m-0 display-4 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-1 mr-1">E-Pemda Bali</span></a></h1>
                </a>
            </div>
...
<?php	//login
	if(isset($_POST['login'])){
		...
		$login = mysqli_query($koneksi,"SELECT * FROM akun WHERE username='$username'");
